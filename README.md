...
|10:03 | <b><a href='https://physics.northwestern.edu/people/faculty/core-faculty/jens-koch.html'>Jens Koch<a/><b/> <br/> Professor *@* Northwestern University <br/> Deputy Director, DOE Center for Superconducting Quantum Materials and Systems (SQMS) <br/> Co-Director, Northwestern-Fermilab Center for Applied Physics of Superconducting Technologies (CAPST) | "Computer-aided quantization and numerical analysis of custom circuits with scqubits" |
